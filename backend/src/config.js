...
const extraMetadata = {
  external_url: "https://opensea.io/MUSEUM-OF-KYIV", // Replace with your website or remove this line if you do not have one.
};
...
const CONTRACT_NAME = "DIGITAL ART";
const CONTRACT_SYMBOL = "DA";
const METADATA_UPDATABLE = false; // set to false if you don't want to allow metadata updates after minting
const OWNER_ADDRESS = "0xd9052b793B507382f6738a7B9a150E828333c5b8";
const TREASURY_ADDRESS = "0xd9052b793B507382f6738a7B9a150E828333c5b8";
...
const ROYALTY_ADDRESS = "0xd9052b793B507382f6738a7B9a150E828333c5b8"; // Address that will receive the royalty
const BASE_URI = null; // only update if you want to manually set the base uri
const PREREVEAL_TOKEN_URI = null; // only update if you want to manually set the prereveal token uri
const PRESALE_WHITELISTED_ADDRESSES = []; // only update if you want to manually set the whitelisted addresses

// ** OPTIONAL **
let CONTRACT_ADDRESS = "0x0AEB78b217E79029E9988bACD6F799c8bb018231"; // If you want to manually include it
...
const solanaMetadata = {
  ...
  external_url: "https://opensea.io/MUSEUM-OF-KYIV",
  creators: [
    {
      address: "0xd9052b793B507382f6738a7B9a150E828333c5b8",
      share: 100,
    },
  ],
};
